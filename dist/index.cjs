...
__export(index_exports, {
  ...
  colorByDatabaseName: () => colorByDatabaseName,
  colorGenericGradient: () => colorGenericGradient,
  colorNcbiBlastGradient: () => colorNcbiBlastGradient,
  colorQualitativeGradient: () => colorQualitativeGradient,
  countDecimals: () => countDecimals,
  dataAsType: () => dataAsType,
  divergentGradient: () => divergentGradient,
  domainDatabaseNameToString: () => domainDatabaseNameToString,
  drawCanvasWrapperStroke: () => drawCanvasWrapperStroke,
  drawColorSchemeCheckBoxText: () => drawColorSchemeCheckBoxText,
  drawContentDomainInfoText: () => drawContentDomainInfoText,
  drawContentFooterTextGroup: () => drawContentFooterTextGroup,
  drawContentHeaderTextGroup: () => drawContentHeaderTextGroup,
  drawContentQuerySubjFooterTextGroup: () => drawContentQuerySubjFooterTextGroup,
  ...
  drawDomainQueySubject: () => drawDomainQueySubject,
  drawDomainTooltips: () => drawDomainTooltips,
  drawDomains: () => drawDomains,
  drawFooterLinkText: () => drawFooterLinkText,
  drawFooterText: () => drawFooterText,
  drawHeaderLinkText: () => drawHeaderLinkText,
  drawHeaderTextGroup: () => drawHeaderTextGroup,
  drawHitTransparentBox: () => drawHitTransparentBox,
  drawHspNoticeText: () => drawHspNoticeText,
  drawLineAxis5Buckets: () => drawLineAxis5Buckets,
  drawLineAxis6Buckets: () => drawLineAxis6Buckets,
  drawLineTracks: () => drawLineTracks,
  drawLineTracksQuerySubject: () => drawLineTracksQuerySubject,
  drawNoHitsFoundText: () => drawNoHitsFoundText,
  drawProteinFeaturesText: () => drawProteinFeaturesText,
  drawScaleColorGradient: () => drawScaleColorGradient,
  drawScaleLabelText: () => drawScaleLabelText,
  drawScaleScoreText: () => drawScaleScoreText,
  drawScaleTick4LabelsGroup: () => drawScaleTick4LabelsGroup,
  drawScaleTick5LabelsGroup: () => drawScaleTick5LabelsGroup,
  drawScaleTypeCheckBoxText: () => drawScaleTypeCheckBoxText,
  drawScoreText: () => drawScoreText,
  drawScoreTypeCheckBoxText: () => drawScoreTypeCheckBoxText,
  drawURLInfoTooltip: () => drawURLInfoTooltip,
  fetchData: () => fetchData,
  getColorType: () => getColorType,
  getDomainPixelCoords: () => getDomainPixelCoords,
  getDomainURLbyDatabase: () => getDomainURLbyDatabase,
  getGradientSteps: () => getGradientSteps,
  getIPRMCDataModelFlatFromXML: () => getIPRMCDataModelFlatFromXML,
  getIPRMCDbfetchAccessions: () => getIPRMCDbfetchAccessions,
  getIPRMCDbfetchURL: () => getIPRMCDbfetchURL,
  getJdispatcherJsonURL: () => getJdispatcherJsonURL,
  getPixelCoords: () => getPixelCoords,
  getQuerySubjPixelCoords: () => getQuerySubjPixelCoords,
  getRgbColorFixed: () => getRgbColorFixed,
  getRgbColorLinearGradient: () => getRgbColorLinearGradient,
  getRgbColorLogGradient: () => getRgbColorLogGradient,
  getTextLegendPaddingFactor: () => getTextLegendPaddingFactor,
  getTotalPixels: () => getTotalPixels,
  getUniqueIPRMCDomainDatabases: () => getUniqueIPRMCDomainDatabases,
  greyscaleGradient: () => greyscaleGradient,
  heatmapGradient: () => heatmapGradient,
  jobIdDefaults: () => jobIdDefaults,
  lineDefaults: () => lineDefaults,
  mouseClickDomain: () => mouseClickDomain,
  mouseDownCheckbox: () => mouseDownCheckbox,
  mouseDownDomainCheckbox: () => mouseDownDomainCheckbox,
  mouseDownLink: () => mouseDownLink,
  mouseOutCheckbox: () => mouseOutCheckbox,
  mouseOutDomain: () => mouseOutDomain,
  mouseOutDomainCheckbox: () => mouseOutDomainCheckbox,
  mouseOutText: () => mouseOutText,
  mouseOverCheckbox: () => mouseOverCheckbox,
  mouseOverDomain: () => mouseOverDomain,
  mouseOverDomainCheckbox: () => mouseOverDomainCheckbox,
  mouseOverText: () => mouseOverText,
  ncbiBlastGradient: () => ncbiBlastGradient,
  numberToString: () => numberToString,
  objectDefaults: () => objectDefaults,
  qualitativeGradient: () => qualitativeGradient,
  rectDefaults: () => rectDefaults,
  sequentialGradient: () => sequentialGradient,
...
function colorQualitativeGradient(start, end) {
  return new import_fabric.fabric.Gradient({
    type: "linear",
    coords: {
      x1: start,
      y1: 0,
...
var import_xml_js = require("xml-js");
var BasicCanvasRenderer = class {
  ...
  getFabricCanvas() {
    ...
    if (this.staticCanvas) {
      this.canvas = new import_fabric2.fabric.StaticCanvas(this.element, startupDef);
    } else {
      this.canvas = new import_fabric2.fabric.Canvas(this.element, startupDef);
    }
  }
  /**
...
function drawHeaderTextGroup(dataObj, renderOptions, topPadding) {
  ...
  const programText = new import_fabric3.fabric.Text(`${program} (version: ${version})`, textObj);
  let db_names = [];
  ...
  topPadding += 15;
  textObj.top = topPadding;
  const databaseText = new import_fabric3.fabric.Text(`Database(s): ${dbs}`, textObj);
  topPadding += 15;
  textObj.top = topPadding;
  const sequenceText = new import_fabric3.fabric.Text("Sequence: ", textObj);
  const length = dataObj.query_len;
  topPadding += 15;
  textObj.top = topPadding;
  const lengthText = new import_fabric3.fabric.Text(`Length: ${length}`, textObj);
  const start = dataObj.start;
  textObj.top = origTopPadding;
  textObj.left = renderOptions.canvasWidth - 170;
  const startText = new import_fabric3.fabric.Text(`${start}`, textObj);
  const end = dataObj.end;
  textObj.top = origTopPadding + 15;
  const endText = new import_fabric3.fabric.Text(`${end}`, textObj);
  const textGroup = new import_fabric3.fabric.Group(
...
function drawHeaderLinkText(dataObj, renderOptions, topPadding) {
  ...
  const sequenceDefText = new import_fabric3.fabric.Text(`${sequence}`, textSeqObj);
...
function drawContentHeaderTextGroup(coordValues, renderOptions, topPadding) {
  ...
  const queryText = new import_fabric3.fabric.Text("Sequence Match", textObj);
  queryText.width = totalQueryPixels;
  textObj.left = coordValues.startEvalPixels;
  let scoreTypeLabel;
  if (renderOptions.scoreType === "identity" /* identity */) {
    scoreTypeLabel = new import_fabric3.fabric.Text("Identity", textObj);
  } else if (renderOptions.scoreType === "similarity" /* similarity */) {
    scoreTypeLabel = new import_fabric3.fabric.Text("Similarity", textObj);
  } else if (renderOptions.scoreType === "bitscore" /* bitscore */) {
    scoreTypeLabel = new import_fabric3.fabric.Text("Bit score", textObj);
  } else {
    scoreTypeLabel = new import_fabric3.fabric.Text("E-value", textObj);
  }
  ...
  const subjText = new import_fabric3.fabric.Text("Subject Match", textObj);
  subjText.width = totalSubjPixels;
  const textGroup = new import_fabric3.fabric.Group([queryText, scoreTypeLabel, subjText], objectDefaults);
  return textGroup;
}
function drawLineTracksQuerySubject(coordValues, renderOptions, topPadding) {
  ...
  const queryLine = new import_fabric3.fabric.Line(coordsQuery, lineObj);
  ...
  const queryStartCap = new import_fabric3.fabric.Line(coordsQueryStartCap, lineObj);
  ...
  const queryEndCap = new import_fabric3.fabric.Line(coordsQueryEndCap, lineObj);
  const coordsSubj = [
  ...
  const subjLine = new import_fabric3.fabric.Line(coordsSubj, lineObj);
  ...
  lineObj.top = topPadding - 2;
  const subjStartCap = new import_fabric3.fabric.Line(coordsSubjStartCap, lineObj);
  ...
  const subjEndCap = new import_fabric3.fabric.Line(coordsSubjEndCap, lineObj);
  const lineGroup = new import_fabric3.fabric.Group(
...
function drawLineTracks(coordValues, renderOptions, topPadding) {
  ...
  const Line = new import_fabric3.fabric.Line(coordsQuery, lineObj);
  ...
  lineObj.top = topPadding - 2;
  const startCap = new import_fabric3.fabric.Line(coordsStartCap, lineObj);
  const coordsEndCap = [
    coordValues.endPixels,
    topPadding - 3,
    coordValues.endPixels,
  ...
  const endCap = new import_fabric3.fabric.Line(coordsEndCap, lineObj);
  const lineGroup = new import_fabric3.fabric.Group([Line, startCap, endCap], objectDefaults);
  return lineGroup;
}
function drawDomainLineTracks(coordValues, renderOptions, topPadding) {
  ...
  lineObj.left = coordValues.startPixels;
  return new import_fabric3.fabric.Line(coordsQuery, lineObj);
}
function drawContentFooterTextGroup(coordValues, renderOptions, topPadding) {
  ...
  const startText = new import_fabric3.fabric.Text(`${coordValues.start}`, textObj);
  let positionFactor = getTextLegendPaddingFactor(`${coordValues.end}`);
  textObj.left = coordValues.endPixels - positionFactor;
  const endText = new import_fabric3.fabric.Text(`${coordValues.end}`, textObj);
  const textGroup = new import_fabric3.fabric.Group([startText, endText], objectDefaults);
  return textGroup;
}
function drawContentQuerySubjFooterTextGroup(coordValues, renderOptions, topPadding) {
  ...
  const startQueryText = new import_fabric3.fabric.Text("1", textObj);
  let positionFactor = getTextLegendPaddingFactor(`${coordValues.queryLen}`);
  textObj.left = coordValues.endQueryPixels - positionFactor;
  const endQueryText = new import_fabric3.fabric.Text(`${coordValues.queryLen}`, textObj);
  textObj.left = coordValues.startSubjPixels - 2.5;
  const startSubjText = new import_fabric3.fabric.Text("1", textObj);
  positionFactor = getTextLegendPaddingFactor(`${coordValues.subjLen}`);
  textObj.left = coordValues.endSubjPixels - positionFactor;
  const endSubjText = new import_fabric3.fabric.Text(`${coordValues.subjLen}`, textObj);
  const textGroup = new import_fabric3.fabric.Group([startQueryText, endQueryText, startSubjText, endSubjText], objectDefaults);
  return textGroup;
}
function drawNoHitsFoundText(renderOptions, topPadding) {
  ...
  textObj.fill = "red";
  const noHitsText = new import_fabric3.fabric.Text("--------------------No hits found--------------------", textObj);
  return noHitsText;
}
function drawContentSequenceInfoText(maxIDLen, hit, renderOptions, topPadding) {
  ...
  const spaceText = new import_fabric3.fabric.Text(variableSpace, textObj);
  ...
  const hitText = new import_fabric3.fabric.Text(hit_def, textObj);
...
function drawHspNoticeText(totalNumberHsps, numberHsps, renderOptions, topPadding) {
  ...
  textObj.left = renderOptions.contentWidth / 2;
  textObj.fill = "red";
  const hspTextNotice = new import_fabric3.fabric.Text(
...
function drawScoreText(startEvalPixels, hsp, renderOptions, topPadding) {
  ...
  if (renderOptions.scoreType === "bitscore" /* bitscore */) {
    hspScoreText = new import_fabric3.fabric.Text(numberToString(hsp.hsp_bit_score), textObj);
  } else if (renderOptions.scoreType === "identity" /* identity */) {
    hspScoreText = new import_fabric3.fabric.Text(numberToString(hsp.hsp_identity), textObj);
  } else if (renderOptions.scoreType === "similarity" /* similarity */) {
    hspScoreText = new import_fabric3.fabric.Text(numberToString(hsp.hsp_positive), textObj);
  } else {
    hspScoreText = new import_fabric3.fabric.Text(numberToString(hsp.hsp_expect), textObj);
  }
  return hspScoreText;
}
...
Similarity: ${numberToString(hsp.hsp_positive)}`;
  const tooltipText = new import_fabric3.fabric.Text(tooltip, floatTextObj);
  const rectObj = { ...rectDefaults };
  rectObj.fill = "white";
  ...
  const tooltipBox = new import_fabric3.fabric.Rect(rectObj);
  const tooltipGroup = new import_fabric3.fabric.Group([tooltipBox, tooltipText], {
    selectable: false,
    evented: false,
    objectCaching: false,
    visible: false,
...
function drawScaleLabelText(renderOptions, topPadding, label) {
  ...
  const scaleTypeText = new import_fabric3.fabric.Text(label, textSelObj);
...
function drawScaleTypeCheckBoxText(renderOptions, topPadding) {
  ...
  const dynamicCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckDynObj);
  textSelObj.left += 140;
  const dynamicText = new import_fabric3.fabric.Text("Dynamic (Score: min to max)", textSelObj);
  ...
  const fixedCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckFixObj);
  textSelObj.left += 220;
  let fixedText;
  if (renderOptions.scoreType === "bitscore" /* bitscore */) {
    fixedText = new import_fabric3.fabric.Text("Fixed (Bit score: <40 to \u2265200)", textSelObj);
  } else if (renderOptions.scoreType === "similarity" /* similarity */) {
    fixedText = new import_fabric3.fabric.Text("Fixed (Similarity: 0.0 to 100.0)", textSelObj);
  } else if (renderOptions.scoreType === "identity" /* identity */) {
    fixedText = new import_fabric3.fabric.Text("Fixed (Identity: 0.0 to 100.0)", textSelObj);
  } else {
    fixedText = new import_fabric3.fabric.Text("Fixed (E-value: 0.0 to 10.0)", textSelObj);
  }
...
function drawScoreTypeCheckBoxText(renderOptions, topPadding) {
  ...
  const evalueCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckEvalueObj);
  textSelObj.left += 140;
  const evalueText = new import_fabric3.fabric.Text("E-value", textSelObj);
  ...
  const identityCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckIdentityObj);
  textSelObj.left += 110;
  const identityText = new import_fabric3.fabric.Text("Identity", textSelObj);
  ...
  const similarityCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckSimilarityObj);
  textSelObj.left += 110;
  const similarityText = new import_fabric3.fabric.Text("Similarity", textSelObj);
  ...
  const bitscoreCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckBitscoreObj);
  textSelObj.left += 120;
  const bitscoreText = new import_fabric3.fabric.Text("Bit score", textSelObj);
  return [
    evalueCheckboxText,
    evalueText,
    textCheckEvalueObj,
...
function drawColorSchemeCheckBoxText(renderOptions, topPadding) {
  ...
  const heatmapCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckHeatmapObj);
  textSelObj.left += 140;
  const heatmapText = new import_fabric3.fabric.Text("Heatmap", textSelObj);
  ...
  const greyscaleCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckGreyscaleObj);
  textSelObj.left += 110;
  const greyscaleText = new import_fabric3.fabric.Text("Greyscale", textSelObj);
  ...
  const sequentialCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckSequentialObj);
  textSelObj.left += 110;
  const sequentialText = new import_fabric3.fabric.Text("Sequential", textSelObj);
  ...
  const divergentCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckDivergentObj);
  textSelObj.left += 120;
  const divergentText = new import_fabric3.fabric.Text("Divergent", textSelObj);
  ...
  const qualitativeCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckQualitativeObj);
  textSelObj.left += 100;
  const qualitativeText = new import_fabric3.fabric.Text("Qualitative", textSelObj);
  ...
  const ncbiblastCheckboxText = new import_fabric3.fabric.Text(checkSym, textCheckNcbiBlastObj);
  textSelObj.left += 100;
  const ncbiblastText = new import_fabric3.fabric.Text("NCBI BLAST+", textSelObj);
  return [
    heatmapCheckboxText,
    heatmapText,
    textCheckHeatmapObj,
...
function drawScaleScoreText(renderOptions, topPadding) {
  ...
  const scaleScoreText = new import_fabric3.fabric.Text(`${scoreTypeLabel}`, textObj);
...
function drawScaleColorGradient(renderOptions, topPadding) {
  ...
  rectObj.height = 15;
  const colorScale = new import_fabric3.fabric.Rect(rectObj);
...
function drawLineAxis5Buckets(startGradPixels, o25GradPixels, o50GradPixels, o75GradPixels, endGradPixels, renderOptions, topPadding) {
  ...
  const axisLine = new import_fabric3.fabric.Line(coordsAxis, lineObj);
  ...
  const axisEndTick = new import_fabric3.fabric.Line(coordsAxisEndTick, lineObj);
  const axisGroup = new import_fabric3.fabric.Group(
...
function drawScaleTick5LabelsGroup(gradientSteps, leftPadding, renderOptions, topPadding) {
  ...
  const o20LabelText = new import_fabric3.fabric.Text(label, textObj);
  ...
  const o40LabelText = new import_fabric3.fabric.Text(label, textObj);
  ...
  const o60LabelText = new import_fabric3.fabric.Text(label, textObj);
  ...
  const o80LabelText = new import_fabric3.fabric.Text(label, textObj);
  ...
  const endLabelText = new import_fabric3.fabric.Text(label, textObj);
  const textGroup = new import_fabric3.fabric.Group(
...
function drawScaleTick4LabelsGroup(gradientSteps, leftPadding, renderOptions, topPadding) {
  ...
  const startLabelText = new import_fabric3.fabric.Text(numberToString(gradientSteps[0]), textObj);
  textObj.left = renderOptions.scaleLabelWidth + leftPadding - numberToString(gradientSteps[1]).length * 3;
  const o25LabelText = new import_fabric3.fabric.Text(numberToString(gradientSteps[1]), textObj);
  textObj.left = renderOptions.scaleLabelWidth + leftPadding * 2 - numberToString(gradientSteps[2]).length * 3;
  const o50LabelText = new import_fabric3.fabric.Text(numberToString(gradientSteps[2]), textObj);
  textObj.left = renderOptions.scaleLabelWidth + leftPadding * 3 - numberToString(gradientSteps[3]).length * 3;
  const o75LabelText = new import_fabric3.fabric.Text(numberToString(gradientSteps[3]), textObj);
  textObj.left = renderOptions.scaleLabelWidth + renderOptions.scaleWidth - numberToString(gradientSteps[4]).length * 3;
  const endLabelText = new import_fabric3.fabric.Text(numberToString(gradientSteps[4]), textObj);
  const textGroup = new import_fabric3.fabric.Group(
...
function drawFooterText(renderOptions, topPadding) {
  ...
  const copyrightText = new import_fabric3.fabric.Text(`${copyright}`, textObj);
...
function drawFooterLinkText(url, renderOptions, topPadding) {
  ...
  textSeqObj.left = 593;
  const sequenceDefText = new import_fabric3.fabric.Text(`${url}`, textSeqObj);
  return [sequenceDefText, textSeqObj];
}
function drawCanvasWrapperStroke(renderOptions) {
  const canvasWrapper = new import_fabric3.fabric.Rect({
    selectable: false,
    evented: false,
    objectCaching: false,
    top: 0,
...
function drawContentTitleText(renderOptions, topPadding) {
  ...
  return new import_fabric3.fabric.Text(`${title}`, textObj);
}
...
function drawProteinFeaturesText(renderOptions, topPadding) {
  ...
  const scaleTypeText = new import_fabric3.fabric.Text("Select your database:", textSelObj);
  return scaleTypeText;
}
function drawDomainCheckbox(renderOptions, topPadding, leftPadding, currentDomainDatabase) {
  ...
  const proteinFeatureRect = new import_fabric3.fabric.Rect(rectObj);
  const proteinFeatureText = new import_fabric3.fabric.Text(currentDomainDatabase, textObj);
...
function drawHitTransparentBox(startPixels, endPixels, topPadding, fill, height) {
  ...
  return new import_fabric3.fabric.Rect(rectObj);
}
function drawContentDomainInfoText(domainID, renderOptions, topPadding) {
  ...
  textObj.evented = true;
  const hitText = new import_fabric3.fabric.Text(domain, textObj);
  return [spaceText, hitText, textObj];
}
...
`;
  ...
  const tooltipText = new import_fabric3.fabric.Textbox(tooltip, floatTextObj);
  const rectObj = { ...rectDefaults };
  rectObj.fill = "white";
  rectObj.stroke = "lightseagreen";
  rectObj.rx = 5;
...
function drawURLInfoTooltip(startPixels, sequence, URL, renderOptions, topPadding) {
  ...
  if (sequence !== "") {
    ...
    tooltipText = new import_fabric3.fabric.Text(`${sequence}
${URL}`, floatTextObj);
  } else {
    const urlLabel = URL.length * 6.3;
    floatTextObj.width = urlLabel + 5;
    tooltipText = new import_fabric3.fabric.Text(`${URL}`, floatTextObj);
  }
  const rectObj = { ...rectDefaults };
  rectObj.fill = "white";
  rectObj.stroke = "lightseagreen";
