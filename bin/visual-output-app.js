            ...
            if (tmpNumberHits <= this.numberHits) {
                ...
                for (const hsp of hit.hit_hsps) {
                    ...
                    if (numberHsps <= this.numberHsps) {
                        ...
                        [queryDomain, subjDomain] = drawDomainQueySubject(startQueryHspPixels, endQueryHspPixels, startSubjHspPixels, endSubjHspPixels, this.topPadding, color);
                        this.canvas.add(queryDomain);
                        this.canvas.add(subjDomain);
                        // E-value text tracks
                        const scoreText = drawScoreText(this.startEvalPixels, hsp, {
                            fontSize: this.fontSize,
                            colorScheme: this.colorScheme,
                        }, this.topPadding);
                        ...
                        if (!this.staticCanvas) {
                            ...
                            mouseOverDomain(queryDomain, startQueryHspPixels, endQueryHspPixels, hspQueryStart, hspQueryEnd, hsp, {
                                fontSize: this.fontSize,
                                colorScheme: this.colorScheme,
                            }, this);
                            mouseOutDomain(queryDomain, this);
                            // Subject hovering and tooltip
                            mouseOverDomain(subjDomain, startSubjHspPixels, endSubjHspPixels, hspSubjStart, hspSubjEnd, hsp, {
                                fontSize: this.fontSize,
                                colorScheme: this.colorScheme,
                            }, this);
